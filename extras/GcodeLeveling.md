...
description:  A Plugin that allows for Leveling of Gcode Z values using manually calculated positions
authors:
- Will MacCormack
license: AGPLv3

date: today's date in format 2020-11-25
...
http://plugins.octoprint.org/plugin/GcodeLeveling/
